...
get_header(); ?>
			...
			<!-- left or right indicates which side has an image -->
				...
				<div class="image-div" style="background:url(<?php echo get_stylesheet_directory_uri(); ?>/img/home-right.png) top center no-repeat;">

				</div>


				<div class="image-div" style="background:url(<?php echo get_stylesheet_directory_uri(); ?>/img/home-left.png) center center no-repeat;">
			...
			<div class="row callout" style="height:400px;background:url(<?php echo get_stylesheet_directory_uri(); ?>/img/pattern@2x.png) center center no-repeat;background-size: cover;">
				<div class="left-text">
					<h3>We Save You</h3>
				...
				<div class="image-div" style="background:url(<?php echo get_stylesheet_directory_uri(); ?>/img/home-bottom.png) center center no-repeat;">
