...
get_header(); ?>
			...
			<div class="banner sub-banner grid-order-one" style="background:url(<?php echo get_stylesheet_directory_uri(); ?>/img/page_banner_9.png) top center no-repeat; height: 407px; margin-bottom: 6px;">
			...
			<div class="green left">
				...
				<div class="image-div first-image grid-order-three" style="background:url(<?php echo get_stylesheet_directory_uri(); ?>/img/about-right-1.png) top center no-repeat;">
			...
			<div class="image-div sixth-image  grid-order-nine" style="background:url(<?php echo get_stylesheet_directory_uri(); ?>/img/home-right.png) top center no-repeat;">
			...
			<div class="row gray-map">
				<div class="left-text">
					...
					<h4>PPO Network</h4>
					<ul>
						<li>Over 35 and Regional</li>
						<li>Over 40 and Feelin Foxy</li>
						<li>65 Plus is just gross</li>
					</ul>

				</div>

				<div class="map-right">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/us-map.png" alt="US Map">
				</div>
					...
					<div class="image-div first-image grid-order-fifteen" style="background:url(<?php echo get_stylesheet_directory_uri(); ?>/img/about-right-1.png) top center no-repeat;">
