...
get_header(); ?>
			...
			<div class="green-reverse left">
				...
				<?php the_field( 'top_left_content_t' ); ?>

			</div>


				<div class="image-div first-image " style="background:url(<?php the_field( 'top_right_image_t' ); ?>) top center no-repeat;">

				</div>

				<div class="image-div second-image " style="background:url(<?php the_field( 'second_row_image' ); ?>) center center no-repeat;">
			...
			<div class="row callout gray ">
					...
					<?php the_field( 'callout_area_text_t' ); ?>
